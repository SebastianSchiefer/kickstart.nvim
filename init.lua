...
-- See `:help mapleader`
--
-- to see how lua is used in nvim
-- :help lua-guide
--
--
...
require('lazy').setup({
  ...
  -- Remember to pass `opts = {}` to not only install but also load it!
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- Open a popup with documentation
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'nix', 'python' },
